...
import java.util.*;
//Теперь коллекция GenealogyTree содержит список всех членов семьи, включая корневой элемент.
// Методы сортировки и печати теперь работают с этим списком, что позволяет отображать и сортировать всех членов семьи.
